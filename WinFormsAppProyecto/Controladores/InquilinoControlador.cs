...
namespace Controladores
{
    public class InquilinoControlador : IControlador<Inquilino>
    {
        ...
        public async Task<Inquilino> add(Inquilino inquilinoNuevo)
        {
            ...
            HttpResponseMessage mensaje = await cliente.PostAsync("http://10.182.169.200:8080/api/inquilinos", content);
        ...
        public async Task<List<Inquilino>> getAll()
        {
            try
            {
                ...
                HttpResponseMessage mensaje = await cliente.GetAsync("http://10.182.169.200:8080/api/inquilinos");
        ...
        public async Task<Inquilino> getById(int id)
        {
            ...
            HttpResponseMessage mensaje = await cliente.GetAsync($"http://10.182.169.200:8080/api/inquilinos/{id}");
            mensaje.EnsureSuccessStatusCode();
            string mensajeJson = await mensaje.Content.ReadAsStringAsync();
        ...
        {
            HttpResponseMessage mensaje = await cliente.DeleteAsync($"http://10.182.169.200:8080/api/inquilinos/{id}");
            mensaje.EnsureSuccessStatusCode();
            return true;
        }
        ...
        public async Task<Inquilino> update(Inquilino inquilinoModificado, int id)
        {
            ...
            HttpResponseMessage mensaje = await cliente.PutAsync($"http://10.182.169.200:8080/api/inquilinos/{id}", content);
            mensaje.EnsureSuccessStatusCode();
        ...
        public async Task<List<Inquilino>> GetInquilinosDePropietario(int propietarioId) { 
            HttpResponseMessage resp = await cliente.GetAsync($"http://10.182.169.200/api/pisos/propietario/{propietarioId}/inquilinos");
